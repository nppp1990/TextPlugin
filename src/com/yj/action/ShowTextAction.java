 ...
 * @created 2014-09-15
 */
public class ShowTextAction extends BaseAndroidGenerateCodeAction {
                        ...
                        public void visitXmlElement(XmlElement element) {
                            ...
                            if (element instanceof XmlTag) {
                                ...
                                if (names.contains(name)) {
                                    if (((XmlTag) element).getAttribute("android:text") != null && !((XmlTag) element).getAttributeValue("android:text").equals("")) {
                                        System.out.println("---blank");
                                    } else {
                                        ((XmlTag) element).setAttribute("android:text", TEXT);
                                    }
                                }
                            }
                        }
